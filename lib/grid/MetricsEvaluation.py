...
def MetricsEvaluation(metrics_list,coeffs,real_dir,saving_dir, n_min,n_max,i_max,r,rho_boug):
 ...
 # ------------------------------------------------------------------------------------------------------
    ...
    if "SSIM" in metrics_list:
        ...
        np.savetxt(saving_dir+'/ssim_U.dat',[ssim_U])
        ...
        np.savetxt(saving_dir+'/ssim_FreeAir.dat',[ssim_FreeAir])
        ...
        np.savetxt(saving_dir+'/ssim_Bouguer.dat',[ssim_Bouguer])
    ...
    if "PSNR" in metrics_list:
        ...
        np.savetxt(saving_dir+'/psnr_U.dat',[psnr_U])
        ...
        np.savetxt(saving_dir+'/psnr_FreeAir.dat',[psnr_FreeAir])
        ...
        np.savetxt(saving_dir+'/psnr_Bouguer.dat',[psnr_Bouguer])
    ...
    if "NCC" in metrics_list:
        ...
        np.savetxt(saving_dir+'/ncc_U.dat',[ncc_U])
        ...
        np.savetxt(saving_dir+'/ncc_FreeAir.dat',[ncc_FreeAir])
        ...
        np.savetxt(saving_dir+'/ncc_Bouguer.dat',[ncc_Bouguer])
